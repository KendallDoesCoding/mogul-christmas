...
If your a developer, I'm sorry but for now the songs, cannot play if the inspect element is open in the background, incase you know how to fix this issue, please give your inputs [here](https://github.com/KendallDoesCoding/mogul-christmas/issues/129). Also, if by any chance, you open the inspect element, even after you close it the songs will not be able to play. Weird aren't it? I just don't know how to fix it rn.
...
Link: [8.2.5/20th version of this website](https://mogulchristmas.kendalldoescoding.gq/version8.2.5)

Github Release Page: [The github release page is listed here](https://mogulchristmas.kendalldoescoding.gq/eighthpointtwopointfive)
